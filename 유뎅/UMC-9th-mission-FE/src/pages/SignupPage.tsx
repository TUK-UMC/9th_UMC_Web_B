...
const schema = z.object({
  ...
  password: z.string().min(8, {message: "비밀번호는 8자 이상입니다."}).max(20, {message: "비밀번호는 20자 이하입니다."}),
  passwordCheck: z.string().min(8, {message: "비밀번호는 8자 이상입니다."}).max(20, {message: "비밀번호는 20자 이하입니다."}),
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="relative">
          <input 
            ...
            name="passwordCheck"
            className={`border w-[300px] p-[10px] focus:outline-none focus:border-[#807bff] rounded-sm
              ${errors?.passwordCheck ? "border-red-500 bg-red-200" : "border-[#ccc]"}`}
